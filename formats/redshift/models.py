...
class AffiliationDistinct(Base):
...
class AffiliationCountryDistinct(Base):
...
class AffiliationContinentDistinct(Base):
...
class AuthorLastKnownInstitutions(Base):
