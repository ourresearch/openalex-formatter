...
def row_dict(work):
    return {
        ...
        'primary_location_id': work.get('primary_location', {}).get('source', {}).get('id'),
        'primary_location_display_name': work.get('primary_location', {}).get('source', {}).get('display_name'),
        'primary_location_host_organization': work.get('primary_location', {}).get('source', {}).get('host_organization'),
        'primary_location_issns': '|'.join(work.get('primary_location', {}).get('source', {}).get('issn') or []),
        'primary_location_issn_l': work.get('primary_location', {}).get('source', {}).get('issn_l'),
        'primary_location_type': work.get('primary_location', {}).get('source', {}).get('type'),
        'primary_location_landing_page_url': work.get('primary_location', {}).get('landing_page_url'),
        'primary_location_pdf_url': work.get('primary_location', {}).get('pdf_url'),
        'primary_location_is_oa': work.get('primary_location', {}).get('is_oa'),
        'primary_location_version': work.get('primary_location', {}).get('version'),
        'primary_location_license': work.get('primary_location', {}).get('license'),
